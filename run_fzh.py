...
#Incremental PID
def control(anglek_2, anglek_1, anglek,VR_1,VL_1):
    # 遇限削弱积分作用
...
def runCar():
    ...
    while True:
        ...
        VR, VL = control(anglek, anglek_1,anglek_2,VR_1,VL_1)
        VR_1 = VR
        VL_1 = VL
        anglek_2=anglek_1
        anglek_1=anglek
...
#目前根据斜率求偏角的合理性，并不是为了让道路处在中线上，而是为了摆正道路。基于此，可以更新出另一个方案，设置道路的预瞄点即可
